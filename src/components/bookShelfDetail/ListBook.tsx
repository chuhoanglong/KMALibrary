...
const ListBook = (props: Props) => {
    ...
    const renderItem = ({ item }: any) => {
        return (
            <RippleButton style={{ margin: 5 }} onPress={goToDetail(item)}>
                <View style={[styles.contain, shadow]}>
                    <Row>
                        ...
                        <View style={styles.styWrapInfo}>
                            <Text style={styles.styName}>{item.nameBook}</Text>
                            <Text style={styles.styNameAuthor}>{item.nameAuthor[0]},</Text>
                        </View>
                        <View style={styles.styWrapInfo}>
                            <Text style={styles.styTxtInfo}>Số trang: {item.numberPage} tr</Text>
                            <Text style={styles.styTxtInfo}>NXB: {item.publicationDate}</Text>
                        </View>
                    </Row>
                </View>
            </RippleButton>
