...
const EditBookScreen = (props: PropsAddBook) => {
    ...
    const validate = () => {
        if (!ten_sach) {
            setError('Bạn chưa điền tên sách!');
            return true;
        }
        if (!ke_sach.ten_ke) {
            setError('Bạn chưa điền tên kệ sách!');
            return true;
        }
        if (!ten_tac_gias) {
            setError('Bạn chưa điền tên tác giả!');
            return true;
        }
        if (!nha_xuat_ban) {
            setError('Bạn chưa điền tên nhà xuất bản!');
            return true;
        }
        if (!ngay_xuat_ban) {
            setError('Bạn chưa điền ngày xuất bản!');
            return true;
        }
        if (!so_trang) {
            setError('Bạn chưa điền số trang!');
            return true;
        }
        if (!gia_sach) {
            setError('Bạn chưa điền giá sách!');
            return true;
        }
        if (!the_loai) {
            setError('Bạn chưa điền thể loại!');
            return true;
        }
        if (!so_luong) {
            setError('Bạn chưa điền số lượng!');
            return true;
        }
        return false;
    }
